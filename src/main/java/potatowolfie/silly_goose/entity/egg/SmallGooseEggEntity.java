...
public class SmallGooseEggEntity extends ThrownItemEntity {
    private static final EntityDimensions EMPTY_DIMENSIONS = EntityDimensions.fixed(0.0F, 0.0F);

    public SmallGooseEggEntity(EntityType<? extends SmallGooseEggEntity> entityType, World world) {
        super(entityType, world);
    }

    public SmallGooseEggEntity(World world, LivingEntity owner, ItemStack stack) {
        super(SillyGooseEntities.SMALL_WHITE_EGG, owner, world, stack);
    }

    public SmallGooseEggEntity(World world, double x, double y, double z, ItemStack stack) {
        super(SillyGooseEntities.SMALL_WHITE_EGG, x, y, z, world, stack);
    }
    ...
    protected Item getDefaultItem() {
        return SillyGooseItems.SMALL_WHITE_EGG;
    }
}